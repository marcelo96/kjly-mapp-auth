...
config :kjly_mapp_auth, KjlyMappAuthWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "3wk74uOkSrj9HcXNp5LNEXRvwbCexwD5O/NgqJ2vELGjXQ3wjVOc2roVi9Zzumyg",
  watchers: [
...
config :kjly_mapp_auth, KjlyMappAuthWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/kjly_mapp_auth_web/(live|views)/.*(ex)$",
      ~r"lib/kjly_mapp_auth_web/templates/.*(eex)$"
    ]
  ]
